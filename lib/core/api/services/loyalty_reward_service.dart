...
/// Appels HTTP des récompenses client (`/rewards`).
class LoyaltyRewardService {
  final ApiClient _apiClient;

  LoyaltyRewardService(this._apiClient);
  ...
  Future<List<Map<String, dynamic>>> listMine() => _guard(() async {
        final response = await _apiClient.dio.get('/rewards');
        return ((response.data as Map)['rewards'] as List)
