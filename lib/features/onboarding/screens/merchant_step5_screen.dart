...
class MerchantStep5Screen extends ConsumerStatefulWidget {
  const MerchantStep5Screen({super.key});

  @override
  ConsumerState<MerchantStep5Screen> createState() => _MerchantStep5ScreenState();
}

class _MerchantStep5ScreenState extends ConsumerState<MerchantStep5Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            const OnboardingProgressBar(current: 5, total: 5),
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Définissez votre programme de fidélité',
                    ...
                    const SizedBox(height: Sp.sm),
                    LoyaltyCardPreview(previewStamps: (state.stampsRequired * 0.7).round()),
                    const SizedBox(height: Sp.xl),
