...
class MerchantStep4Screen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            const OnboardingProgressBar(current: 4, total: 5),
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Optionnel — visible sur votre vitrine',
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: AppButton.primary('Continuer',
                        ...
                        onPressed: () => context.go('/auth/merchant/step5')),
                  ),
                ],
              ),
            ),
